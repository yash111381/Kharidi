...
<template:template_user title="Product View">
	   ...
	   <div class="products-page">
			<div class="products">
				...
				<div class="latest-bis">
					<img src="resources/images/l4.jpg" class="img-responsive" alt="" />
					<div class="offer">
						<p>40%</p>
			...
			<div class="new-product">
					...
					<div class="flexslider">
						<ul class="slides">
							<li data-thumb="resources/images/si.jpg">
								<div class="thumb-image"> <img src="resources/images/si.jpg" data-imagezoom="true" class="img-responsive" alt="" /> </div>
							</li>
							<li data-thumb="resources/images/si1.jpg">
								<div class="thumb-image"> <img src="resources/images/si1.jpg" data-imagezoom="true" class="img-responsive" alt="" /> </div>
							</li>
							<li data-thumb="resources/images/si2.jpg">
							<div class="thumb-image"> <img src="resources/images/si2.jpg" data-imagezoom="true" class="img-responsive" alt="" /> </div>
							</li> 
						</ul>
					</div>
				</div>
				...
				<script src="resources/scripts/imagezoom.js"></script>
					<!-- FlexSlider -->
		  ...
		  <div class="response">
						<div class="media response-info">
							<div class="media-left response-text-left">
								<a href="#">
									<img class="media-object" src="resources/images/icon1.png" alt="" />
								</a>
   ...
   <!-- content-section-ends -->
    ...
    <script src="resources/scripts/responsive-tabs.js"></script>
